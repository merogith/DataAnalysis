...
## A note on the data
Project 3 uses real, public market data from Shiller, CBOE, and LBMA. The brief asked for yfinance
and FRED, but both were blocked by the sandbox network, so I used GitHub-hosted mirrors of the same
sources and documented the change in that project's `NOTES.md`. Projects 1 and 2 use synthetic data,
generated by reproducible seeded scripts that inject realistic messiness, because real pharma CRM
and game telemetry are proprietary.
