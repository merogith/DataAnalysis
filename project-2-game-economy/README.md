...
> Data label: SYNTHETIC. All telemetry is generated by one seeded script (`data/generate_data.py`). Real F2P telemetry is proprietary and privacy-sensitive, so a reproducible synthetic generator was the practical path (see `NOTES.md`).
